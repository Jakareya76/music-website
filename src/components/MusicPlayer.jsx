const MusicPlayer = () => {
  return (
    <div className="flex flex-col px-5 w-full border-2 border-black py-3 bg-[#232A4E] rounded-xl mt-5">
      <div className="flex items-center justify-between">
        <div className="flex">
          <img
            src={require("../assets/Mask Group 23.png")}
            alt=""
            className="w-[2.5rem] h-[2.5rem] border-2 border-white rounded-full"
          />
          <div className="flex flex-col ml-4">
            <span className="text-[1rem]">So Far Away</span>
      ...
      <div className="flex items-center justify-between mt-5">
        <div className="flex items-center justify-between text-sm text-gray-500 flex-[2]">
          <span>2: 30</span>
          <img src={require("../assets/Group 9.png")} alt="" className="w-[16rem]" />
          <span>4: 30</span>
        </div>
