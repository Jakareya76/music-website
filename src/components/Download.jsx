...
const Download = () => {
  return (
    <div className="flex flex-col items-center justify-start px-[5rem] bg-[#020917] h-[48rem] pt-[18rem] mt-[-10rem] relative z-[1] rounded-b-[5rem]">
      {/* tild icon or path icon */}
      <img src={require("../assets/Path 318.png")} alt="" className="w-[5rem]" />
      {/* heading */}
